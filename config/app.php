...
return [
    ...
    */
    'hooks' => [
        ...
        App\Hooks\PostType\Blog::class,

        // Ajax providers
        App\Hooks\Ajax\LatestArticles::class,
        App\Hooks\Ajax\Blog::class,
        App\Hooks\Ajax\Contact::class,
        App\Hooks\Ajax\RegisterMark::class,
        App\Hooks\Ajax\TrademarkRegistration::class
    ],
